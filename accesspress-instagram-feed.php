...
/*
Plugin name: Impression Instagram Feed
Plugin URI: 
Description: A plugin for loading Instagram Feed
Version: 2.1.0
Author: Tu Nguyen
Author URI: http://minhtu.net
Text Domain: impression-instagram-feed
Domain Path: 
...
if( !defined( 'APIF_TEXT_DOMAIN' ) ) {
    define( 'APIF_TEXT_DOMAIN', 'impression-instagram-feed' );
}
//Include admin
 ...
 *
 */
include_once('inc/backend/user-fields.php');
...
if( !class_exists( 'IF_Class' ) ) {
    ...
    class IF_Class {
        ...
        function plugin_text_domain() {
            load_plugin_textdomain( 'impression-instagram-feed', false, basename( dirname( __FILE__ ) ) . '/languages/' );
        }
        /**
        ...
        //slider shortcode
        function ap_instagram_slider($atts) {
